...
Polymer({
  _template: html`
        ...
        <div id="viewport" class\$="{{_applyOverflowVisibility(isTouch)}}" on-mousedown="_dragStart" on-mousemove="_dragMove" on-mouseup="_dragStop" on-mouseout="_dragCancel" on-wheel="horizontalScroll">
            <div id="content">
